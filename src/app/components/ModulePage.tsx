      ...
      <div className="w-full h-full flex flex-row items-start justify-baseline">
        ...
        <div className="w-full flex flex-col items-center justify-start mt-10">
          ...
          <p className="text-black w-3/4">
            ...
            más aútonomo buscando información en interner, te propongo
            solucionar tus problemas con el código buscando en la documentación
            oficial, posts de Stack Overflow o tutoriales de Youtube.{" "}
          </p>
        </div>
      </div>
    </div>
